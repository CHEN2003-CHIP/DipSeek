...
def init_model(args):
    ...
    if 'model' in args.load_from:
        model = DipSeekForCausalLM(DipSeekConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe)))
...
def main():
    parser = argparse.ArgumentParser(description="DipSeek ToolCall评测")
    ...
    parser.add_argument('--api_model', default='dipseek-local:latest', type=str, help="API请求时使用的模型名称")
