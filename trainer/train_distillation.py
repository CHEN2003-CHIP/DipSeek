...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="DipSeek Knowledge Distillation")
    ...
    parser.add_argument("--wandb_project", type=str, default="DipSeek-Distillation", help="wandb项目名")
    ...
    lm_config_student = DipSeekConfig(hidden_size=args.student_hidden_size, num_hidden_layers=args.student_num_layers, use_moe=bool(args.student_use_moe))
    lm_config_teacher = DipSeekConfig(hidden_size=args.teacher_hidden_size, num_hidden_layers=args.teacher_num_layers, use_moe=bool(args.teacher_use_moe))
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"DipSeek-Distill-S{args.student_hidden_size}T{args.teacher_hidden_size}-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
