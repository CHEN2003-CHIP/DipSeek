...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DipSeek Agent RL")
    ...
    parser.add_argument("--wandb_project", type=str, default="DipSeek-Agent-RL", help="wandb项目名称")
    ...
    lm_config = DipSeekConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers,
